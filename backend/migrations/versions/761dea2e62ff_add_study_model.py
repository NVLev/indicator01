...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "most_dangerous_pathology_type", sa.String(length=255), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_studies_processing_status"),
        "studies",
        ["processing_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_studies_ready_for_inference"),
        "studies",
        ["ready_for_inference"],
        unique=False,
    )
    op.create_index(
        op.f("ix_studies_study_uid"), "studies", ["study_uid"], unique=False
    )
