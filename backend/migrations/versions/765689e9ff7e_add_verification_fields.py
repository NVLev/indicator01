...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('studies', sa.Column('needs_verification', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('studies', sa.Column('verification_results', sa.JSON(), nullable=True))
